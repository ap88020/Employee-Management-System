  ...
  return (
        <div className='w-[300px] bg-yellow-300 h-full rounded-xl flex-shrink-0 '>
            <div className='flex justify-between items-center p-5 bg-transparent'>
                ...
                <h1 className='font-bold text-base bg-transparent text-black'>{elem.taskDate}</h1>
            </div>
            <h1 className='text-2xl px-3 font-semibold  bg-transparent text-black'>{elem.taskTitle}</h1>
            <p className=' px-3 mt-2 font-medium bg-transparent text-black'>
                {elem.taskDescription}
            </p>
            <div className='bg-transparent px-2 mt-3'>
                <button className='bg-red-600 font-bold rounded-md px-2 py-1'>Faild</button>
            </div>
        </div>
  )
}
